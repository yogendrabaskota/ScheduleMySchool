...
const UserVerification = () => {
  ...
  const rejectUser = async (id) => {
    ...
    try {
      await axiosInstance.delete(`http://localhost:5000/api/auth/deleteUser/${id}`); // Assuming DELETE request
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <div className="flex-grow p-8">
        ...
        {users.length === 0 ? (
          <div className="text-center text-gray-500">No unverified users found.</div>
        ) : (
