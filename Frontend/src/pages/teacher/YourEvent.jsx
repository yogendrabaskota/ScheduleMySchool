    ...
    <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      <div className="p-6">
        <div className="flex justify-between items-start mb-4">
          ...
          <span className="bg-[#00BCD4]/10 text-[#00BCD4] text-xs font-semibold px-2.5 py-0.5 rounded">
            Upcoming
          </span>
        </div>
        ...
        <div className="space-y-3 mb-6">
          <div className="flex items-center">
            <svg
              className="w-4 h-4 text-[#3F51B5] mr-2"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <div className="flex justify-between">
            <div
              className={`text-sm font-medium ${
                availableTickets > 0 ? "text-[#4CAF50]" : "text-[#F44336]"
              }`}
            >
              <svg
        ...
        <div className="flex justify-between space-x-3">
          ...
          <Link to={`/event/update/${id}`} className="flex-1">
            <button className="w-full bg-[#FF9800] hover:bg-[#F57C00] text-white font-medium py-2 px-4 rounded-lg transition-colors">
              Update
            </button>
          </Link>
        </div>
